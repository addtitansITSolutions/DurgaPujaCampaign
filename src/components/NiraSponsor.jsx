...
const products = [
  {
    key: "incensestick",
    image: "/nira/incense_stick.jpeg",
    amazonUrl: "https://www.amazon.in/s?k=NIRA+Incense+Stick",
  },
  {
    key: "dhoopCones",
    image: "/nira/dhoop-cone.jpeg",
    amazonUrl: "https://www.amazon.in/s?k=NIRA+Dhoop+Cones",
  },
  {
    key: "dhoopSticks",
    image: "/nira/dhoop_sticks.png",
    amazonUrl: "https://www.amazon.in/s?k=NIRA+Dhoop+Sticks",
  },
  {
    key: "SambraniCup",
    image: "/nira/SambraniCup.jpeg",
    amazonUrl: "https://www.amazon.in/s?k=NIRA+Sambrani+Cup",
  },
  {
    key: "FragranceOil",
    image: "/nira/FragranceOil.jpeg",
    amazonUrl: "https://www.amazon.in/s?k=NIRA+Fragrance+Oil",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="overflow-hidden rounded-[26px] border border-[#6d311d]/10 bg-[#fffaf3] shadow-[0_20px_70px_rgba(72,35,18,0.08)]">
          ...
          <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs font-medium leading-5 text-[#2a110b]/55">
                    {t("nira.discountDescription")}
                  </p>
                </div>
            ...
            <div className="min-w-0 border-t border-[#6d311d]/10 bg-[#efe0ca] p-5 sm:p-7 lg:border-l lg:border-t-0 lg:p-6">
                      ...
                      >
                        ...
                        <div className="relative aspect-[4/4.6] overflow-hidden rounded-2xl bg-[#e3d0b5]">
                          ...
                          <img
                            src={product.image}
                            alt={t(`nira.products.${product.key}`)}
                            className="h-full w-full rounded-xl object-cover p-1 transition-transform duration-700 ease-out group-hover:scale-105"
                          />
                        ...
                        <div className="mt-3 px-1">
                          ...
                          <div className="mt-2 flex items-center justify-between gap-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wider text-[#a56622]">
                              {t("nira.discountShort")}
                            </span>

                            <span className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-[#8f321d] transition-transform duration-300 group-hover:translate-x-1">
                              {t("nira.viewOnAmazon")}
                              <ArrowUpRight size={11} />
                            </span>
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-[#e3d0b5]">
                      ...
                      <img
                        src={product.image}
                        alt={t(`nira.products.${product.key}`)}
                        className="h-full w-full rounded-3xl object-cover p-2 transition-transform duration-700 ease-out group-hover:scale-105"
                      />
